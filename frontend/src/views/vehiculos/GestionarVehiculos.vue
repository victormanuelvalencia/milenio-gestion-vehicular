      ...
      <div class="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden">
        ...
        <form @submit.prevent="crearVehiculo" class="p-6 space-y-4">
          ...
          <div>
            ...
            <input v-model="formularioCreacion.placa" required placeholder="ej. ABC123" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm" />
          </div>
          <div>
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <input v-model.number="formularioCreacion.ano" type="number" required min="1900" :max="new Date().getFullYear() + 1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" />
            </div>
            <div>
