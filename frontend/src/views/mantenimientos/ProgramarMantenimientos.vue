            ...
            >
              ...
              <td class="px-3 py-3">
                <div class="flex items-center justify-center gap-2">
                  <button @click="abrirModalHecho(m)" title="Marcar como Hecho" class="flex items-center gap-1 text-xs font-medium text-emerald-600 hover:text-emerald-800 border border-emerald-200 hover:border-emerald-400 rounded-md px-2 py-1 transition-colors bg-emerald-50 hover:bg-emerald-100">
