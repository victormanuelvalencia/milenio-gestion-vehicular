    ...
    <div v-else class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
      <table class="w-full text-sm text-center table-fixed">
        <thead class="bg-slate-800 text-white text-xs tracking-wide">
          <tr>
            <th class="px-4 py-3 w-[65%]">Nombre</th>
        ...
        <tbody class="divide-y divide-gray-100">
          ...
          <template v-for="e in empresasPaginadas" :key="e.id">
            <tr v-if="editando !== e.id" class="hover:bg-slate-50">
            ...
            <tr v-else-if="puedeEscribir && editando === e.id" class="bg-blue-50 border-l-4 border-blue-500">
