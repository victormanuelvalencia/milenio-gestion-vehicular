    ...
    <div v-else class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
      <table class="w-full text-sm text-center table-fixed">
        ...
        <tbody class="divide-y divide-gray-100">
          ...
          <template v-for="t in tiposPaginados" :key="t.id">
            <tr v-if="editando !== t.id" class="hover:bg-slate-50">
            ...
            <tr v-else-if="puedeEscribir && editando === t.id" class="bg-blue-50 border-l-4 border-blue-500">
