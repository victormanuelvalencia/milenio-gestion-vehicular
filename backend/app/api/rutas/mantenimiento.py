...
def crear_mantenimiento(mantenimiento: MantenimientoCrear, bd: Session = Depends(obtener_bd)):
...
def actualizar_mantenimiento(id_mantenimiento: int, mantenimiento: MantenimientoActualizar, bd: Session = Depends(obtener_bd)):
...
def eliminar_mantenimiento(id_mantenimiento: int, bd: Session = Depends(obtener_bd)):
