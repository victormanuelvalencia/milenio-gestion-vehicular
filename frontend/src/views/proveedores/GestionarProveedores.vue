      ...
      <div class="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden">
        ...
        <form @submit.prevent="crearProveedor" class="p-6 space-y-4">
          ...
          <div>
            ...
            <input v-model="formularioCreacion.nombre" required placeholder="ej. Estación El Progreso" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm" />
          </div>
          <div>
